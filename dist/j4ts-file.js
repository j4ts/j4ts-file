    ...
    (function (io) {
        ...
        var FileSystem = /** @class */ (function () {
            ...
            /*private*/ FileSystem.getBooleanProperty = function (prop, defaultVal) {
                ...
                if (val == null)
                    return defaultVal;
                if ( /* equalsIgnoreCase */(function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(val, "true")) {
                    return true;
                }
                else {
                    return false;
...
(function (java) {
    ...
    (function (io) {
         ...
         */
        var FileInputStream = /** @class */ (function (_super) {
            __extends(FileInputStream, _super);
            function FileInputStream(n) {
                var _this = this;
                if (((typeof n === 'string') || n === null)) {
                    var __args = arguments;
                    {
                        var __args_4 = arguments;
                        var file = n != null ? new java.io.File(n) : null;
                        _this = _super.call(this) || this;
                        if (_this.content === undefined) {
                            _this.content = null;
                        }
                        ...
                        var name_1 = (file != null ? file.getPath() : null);
                        if (name_1 == null) {
                ...
                else if (((n != null && n instanceof java.io.File) || n === null)) {
                    var __args = arguments;
                    var file = __args[0];
                    _this = _super.call(this) || this;
                    if (_this.content === undefined) {
                    ...
                    var name_2 = (file != null ? file.getPath() : null);
                    if (name_2 == null) {
                        throw new java.lang.NullPointerException();
                    }
                    if (file.isInvalid()) {
    ...
    (function (io) {
        var LocalStorageFileSystem = /** @class */ (function (_super) {
            ...
            LocalStorageFileSystem.fs_$LI$ = function () { if (LocalStorageFileSystem.fs == null) {
                LocalStorageFileSystem.fs = new LocalStorageFileSystem();
            } return LocalStorageFileSystem.fs; };
            /**
             *
             * @return {string}
             */
            ...
            LocalStorageFileSystem.prototype.fromURIPath = function (path) {
                var p = path;
                if ( /* endsWith */(function (str, searchString) { var pos = str.length - searchString.length; var lastIndex = str.indexOf(searchString, pos); return lastIndex !== -1 && lastIndex === pos; })(p, "/") && (p.length > 1)) {
            ...
            LocalStorageFileSystem.prototype.createFileEntry = function (pathname) {
                ...
                }, 'constructor', { configurable: true, value: { __interfaces: ["java.io.LocalStorageFileSystem.Entry"] } }));
                return e;
            };
            /**
             *
            ...
            LocalStorageFileSystem.prototype.removeEntry = function (pathname) {
                {
                    var array = this.getChildEntries(pathname);
            ...
            LocalStorageFileSystem.prototype.createDirectory = function (f) {
                ...
                this.putEntry(f.getAbsolutePath(), Object.defineProperty({
                    ...
                    access: java.io.FileSystem.ACCESS_READ | java.io.FileSystem.ACCESS_WRITE,
                    entries: []
                }, 'constructor', { configurable: true, value: { __interfaces: ["java.io.LocalStorageFileSystem.DirectoryEntry", "java.io.LocalStorageFileSystem.Entry"] } }));
                return true;
            };
            /**
             *
            ...
            LocalStorageFileSystem.prototype.compare = function (f1, f2) {
                return /* compareTo */ f1.getAbsolutePath().localeCompare(f2.getAbsolutePath());
            };
            /**
             *
             * @param {java.io.File} f
...
(function (java) {
    ...
    (function (io) {
        ...
        var File = /** @class */ (function () {
            function File(parent, child, direct) {
                if (((parent != null && parent instanceof java.io.File) || parent === null) && ((typeof child === 'string') || child === null) && ((typeof direct === 'boolean') || direct === null)) {
                    ...
                    this.status = null;
                    this.path = java.io.LocalStorageFileSystem.fs_$LI$().resolve$java_lang_String$java_lang_String(parent.path, child);
                    ...
                    if (parent != null) {
                        if (parent === ("")) {
                            this.path = java.io.LocalStorageFileSystem.fs_$LI$().resolve$java_lang_String$java_lang_String(java.io.LocalStorageFileSystem.fs_$LI$().getDefaultParent(), java.io.LocalStorageFileSystem.fs_$LI$().normalize$java_lang_String(child));
                        }
                        else {
                            this.path = java.io.LocalStorageFileSystem.fs_$LI$().resolve$java_lang_String$java_lang_String(java.io.LocalStorageFileSystem.fs_$LI$().normalize$java_lang_String(parent), java.io.LocalStorageFileSystem.fs_$LI$().normalize$java_lang_String(child));
                        }
                    }
                    else {
                        this.path = java.io.LocalStorageFileSystem.fs_$LI$().normalize$java_lang_String(child);
                    }
                    this.prefixLength = java.io.LocalStorageFileSystem.fs_$LI$().prefixLength(this.path);
                }
                    ...
                    if (parent != null) {
                        if (parent.path === ("")) {
                            ...
                            this.path = java.io.LocalStorageFileSystem.fs_$LI$().resolve$java_lang_String$java_lang_String(parent.path, java.io.LocalStorageFileSystem.fs_$LI$().normalize$java_lang_String(child));
                        }
                    }
                    else {
                        this.path = java.io.LocalStorageFileSystem.fs_$LI$().normalize$java_lang_String(child);
                    ...
                    var __args = arguments;
                    var pathname = __args[0];
                    var prefixLength = __args[1];
                    if (this.path === undefined) {
                        this.path = null;
                    }
                    if (this.prefixLength === undefined) {
                    ...
                    this.path = java.io.LocalStorageFileSystem.fs_$LI$().normalize$java_lang_String(pathname);
                    this.prefixLength = java.io.LocalStorageFileSystem.fs_$LI$().prefixLength(this.path);
                }
                else
                    throw new Error('invalid overload');
            ...
            File.separatorChar_$LI$ = function () { if (File.separatorChar == null) {
                File.separatorChar = java.io.LocalStorageFileSystem.fs_$LI$().getSeparator();
            } return File.separatorChar; };
            File.separator_$LI$ = function () { if (File.separator == null) {
                File.separator = "" + File.separatorChar_$LI$();
            } return File.separator; };
            File.pathSeparatorChar_$LI$ = function () { if (File.pathSeparatorChar == null) {
                File.pathSeparatorChar = java.io.LocalStorageFileSystem.fs_$LI$().getPathSeparator();
            } return File.pathSeparatorChar; };
            File.pathSeparator_$LI$ = function () { if (File.pathSeparator == null) {
                File.pathSeparator = "" + File.pathSeparatorChar_$LI$();
            ...
            File.slashify = function (path, isDirectory) {
                ...
                if ((function (c) { return c.charCodeAt == null ? c : c.charCodeAt(0); })(File.separatorChar_$LI$()) != '/'.charCodeAt(0))
                    p = /* replace */ p.split(File.separatorChar_$LI$()).join('/');
        ...
        (function (File) {
            ...
            var TempDirectory = /** @class */ (function () {
                function TempDirectory() {
                }
                TempDirectory.tmpdir_$LI$ = function () { if (TempDirectory.tmpdir == null) {
                    TempDirectory.tmpdir = new java.io.File(java.lang.System.getProperty("java.io.tmpdir"));
                ...
                TempDirectory.generateFile = function (prefix, suffix, dir) {
                    var n = (function (n) { return n < 0 ? Math.ceil(n) : Math.floor(n); })(Math.random()) * javaemul.internal.LongHelper.MAX_VALUE;
                    ...
                    var name = prefix + /* toString */ ('' + (n)) + suffix;
